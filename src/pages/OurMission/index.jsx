        ...
        <div className="w-full xl:w-[48%] pt-8 xl:pt-0">
          {listOurMission.map((e, idx) => (
            <div
              ...
              className="border border-[#3B4060] rounded-lg bg-gradient-to-r from-[#191A21] text-gray-50 via-transparent to-transparent hover:border-brand hover:bg-gradient-to-r hover:from-[#355646]  mb-8 p-4"
            >
